...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .d1 { width: 300px; height: 300px; background: #ef4444; top: -100px; right: -100px; }
        .d2 { width: 200px; height: 200px; background: #7c3aed; bottom: -50px; left: -50px; }
    </style>
</head>
<body>
    ...
    <div class="container">
        ...
        <p>Terjadi kesalahan pada server. Silakan coba lagi nanti atau hubungi administrator.</p>
        <a href="/" class="btn">
